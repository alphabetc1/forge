...
$SkillName = "claude-codex-sync"
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$SourceItems = @("SKILL.md", "README.md", "agents", "scripts", "claude-codex-sync")
...
Write-Host ""
Write-Host "Next:"
Write-Host "  Codex : start a new session, then invoke with `$claude-codex-sync"
Write-Host "  Claude: start a new session, then invoke with /claude-codex-sync"
